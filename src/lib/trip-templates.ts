...
/** Same labels as experienceCategoryLabel — personalize ↔ day votes stay aligned. */
export const personalizeOptions: Array<{
  id: ExperienceCategory;
  label: string;
}> = [
  { id: "SIGHTS", label: experienceCategoryLabel.SIGHTS },
  { id: "FOOD", label: experienceCategoryLabel.FOOD },
  { id: "CULTURE", label: experienceCategoryLabel.CULTURE },
  { id: "NATURE", label: experienceCategoryLabel.NATURE },
  { id: "LIVE_ENTERTAINMENT", label: experienceCategoryLabel.LIVE_ENTERTAINMENT },
  { id: "SHOPPING", label: experienceCategoryLabel.SHOPPING },
  { id: "FAMILY", label: experienceCategoryLabel.FAMILY },
  { id: "RELAX", label: experienceCategoryLabel.RELAX },
  { id: "NIGHTLIFE", label: experienceCategoryLabel.NIGHTLIFE },
  { id: "RELIGIOUS", label: experienceCategoryLabel.RELIGIOUS },
  { id: "FREE_TIME", label: experienceCategoryLabel.FREE_TIME },
  { id: "WATER_ACTIVITY", label: experienceCategoryLabel.WATER_ACTIVITY },
  { id: "PRIVATE_GROUP_EVENT", label: experienceCategoryLabel.PRIVATE_GROUP_EVENT },
];
  ...
  // —— Hotel area ——
  {
    ...
    blocks: [
      flexDay(
        "mh1",
        "Day 1",
        experienceCategoryLabel.SIGHTS,
        "Near the hotel — pick the vibe that fits arrival day.",
        [
          {
            id: "mh1-sights",
            category: "SIGHTS",
            title: experienceCategoryLabel.SIGHTS,
            summary: "Walkable Midtown icons — landmarks near the hotel.",
            viatorQuery: "Midtown walking tour",
          },
          {
            id: "mh1-food",
            category: "FOOD",
            title: experienceCategoryLabel.FOOD,
            summary: "Midtown food crawl — markets, slices, quick bites.",
            viatorQuery: "New York food tour",
          },
          {
            id: "mh1-shop",
            category: "SHOPPING",
            title: experienceCategoryLabel.SHOPPING,
            summary: "Fifth Avenue and the hotel-belt retail spine.",
            viatorQuery: "shopping",
          },
          {
            id: "mh1-relax",
            category: "RELAX",
            title: experienceCategoryLabel.RELAX,
            summary: "Easy arrival — light walking, cafe time, early night.",
          },
          {
            id: "mh1-nightlife",
            category: "NIGHTLIFE",
            title: experienceCategoryLabel.NIGHTLIFE,
            summary: "Times Square evening energy near the hotel.",
            viatorQuery: "Times Square nightlife",
          },
          {
            id: "mh1-free",
            category: "FREE_TIME",
            title: experienceCategoryLabel.FREE_TIME,
            summary: "Settle in — no big plan, keep the first day soft.",
          },
        ],
        {
          fromHotelMinutes: 15,
      ...
      flexDay(
        "mh2",
        "Day 2",
        experienceCategoryLabel.CULTURE,
        "A fuller day — culture, parks, shows, or downtown.",
        [
          {
            id: "mh2-culture",
            category: "CULTURE",
            title: experienceCategoryLabel.CULTURE,
            summary: "MoMA, Met, or a museum afternoon.",
            viatorQuery: "museum",
          },
          {
            id: "mh2-nature",
            category: "NATURE",
            title: experienceCategoryLabel.NATURE,
            summary: "Central Park deep dive — green space mid-trip.",
            viatorQuery: "Central Park",
          },
          {
            id: "mh2-show",
            category: "LIVE_ENTERTAINMENT",
            title: experienceCategoryLabel.LIVE_ENTERTAINMENT,
            summary: "Broadway or a live show night.",
            viatorQuery: "Broadway",
          },
          {
            id: "mh2-sights",
            category: "SIGHTS",
            title: experienceCategoryLabel.SIGHTS,
            summary: "Harbor / Statue of Liberty day downtown.",
            viatorQuery: "Statue of Liberty",
          },
          {
            id: "mh2-food",
            category: "FOOD",
            title: experienceCategoryLabel.FOOD,
            summary: "Downtown food — Chinatown, LES, or ferry-side eats.",
            viatorQuery: "New York food tour",
          },
          {
            id: "mh2-family",
            category: "FAMILY",
            title: experienceCategoryLabel.FAMILY,
            summary: "Lower-stress pacing built for kids and mixed ages.",
            viatorQuery: "family New York",
          },
          {
            id: "mh2-water",
            category: "WATER_ACTIVITY",
            title: experienceCategoryLabel.WATER_ACTIVITY,
            summary: "Hudson River cruise or ferry time on the water.",
            viatorQuery: "Hudson River cruise",
          },
          {
            id: "mh2-private",
            category: "PRIVATE_GROUP_EVENT",
            title: experienceCategoryLabel.PRIVATE_GROUP_EVENT,
            summary: "Private group dinner — book a table for everyone.",
            specialProviderRequired: true,
          },
        ],
        {
      ...
      flexDay(
        "mh3",
        "Day 3",
        experienceCategoryLabel.NATURE,
        "Last morning near Midtown — or one more signature stop.",
        [
          {
            id: "mh3-nature",
            category: "NATURE",
            title: experienceCategoryLabel.NATURE,
            summary: "Park morning + buffer before checkout.",
            viatorQuery: "Central Park",
          },
          {
            id: "mh3-sights",
            category: "SIGHTS",
            title: experienceCategoryLabel.SIGHTS,
            summary: "SUMMIT / Edge-style viewpoint before you leave.",
            viatorQuery: "SUMMIT",
          },
          {
            id: "mh3-religious",
            category: "RELIGIOUS",
            title: experienceCategoryLabel.RELIGIOUS,
            summary: "Quiet churches, cathedrals, or memorials.",
          },
          {
            id: "mh3-shop",
            category: "SHOPPING",
            title: experienceCategoryLabel.SHOPPING,
            summary: "Last-morning gifts near Midtown.",
            viatorQuery: "shopping",
          },
          {
            id: "mh3-culture",
            category: "CULTURE",
            title: experienceCategoryLabel.CULTURE,
            summary: "One more museum morning if the group wants it.",
            viatorQuery: "museum",
          },
          {
            id: "mh3-relax",
            category: "RELAX",
            title: experienceCategoryLabel.RELAX,
            summary: "Slow checkout morning — cafe and light walk only.",
          },
          {
            id: "mh3-free",
            category: "FREE_TIME",
            title: experienceCategoryLabel.FREE_TIME,
            summary: "Open morning — no fixed plan before you go.",
          },
        ],
        {
          fromHotelMinutes: 20,
